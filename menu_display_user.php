 ...
 {  
      ...
      {  
           ...
           {  
                ...
                $sql_stock = "SELECT Stock FROM menu WHERE Id=$id";
                ...
                if(mysqli_num_rows($result_stock) == 1){
                  ...
                  $sql_update = "UPDATE menu SET Stock='$new_stock' WHERE Id=$id";
                  $result_update =  mysqli_query($connect, $sql_update);
                }
           }  
           else  
           {  
                echo '<script>alert("Item Already Added"); location="./menu_display_user.php";</script>';
           }  
      }  
      else  
      {  
      ...
      {  
           ...
           {  
                ...
                {  
                     ...
                     echo '<script>alert("Item Removed"); location="./menu_display_user.php";</script>'; 
                }  
           }  
      }  
 }  
...
<body>
    ...
    <div class="btn-group">
      ...
      <div class="container" style="width:700px;">
        ...
        <div class="table-responsive">  
             <table class="table table-bordered">  
                  ...
                  <tr>  
                       ...
                       <td><a href="menu_display_user.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>  
                  </tr>  
                  <?php  
        ...
        ?>  
        <div class="col-md-4">  
             <form method="post" action="./menu_display_user.php?action=add&id=<?php echo $row['Id']; ?>">  
