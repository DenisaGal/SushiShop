...
<?php
 ...
 {  
    $id = $_GET["id"];
    $sql_restock = "UPDATE menu SET Stock=100 WHERE Id=$id";
...
<body>
    ...
    <div class="btn-group">
      ...
      <div class="container" style="width:700px;">
        ...
        <?php endif ?>
      <center><form method="post" action="admin-menu.php" enctype="multipart/form-data">
      <big><div class="input-group">
        <input type="hidden" name="id" value="<?php echo $id; ?>">
        <label>Category</label>
        </br>
        <input type="text" name="category" value="<?php if ($update == true){echo $category;} else echo ""?>">
        <label>Name</label>
        </br>
        <input type="text" name="name" value="<?php if ($update == true){echo $name;} else echo ""?>">
        <label>Ingredients</label>
        </br>
        <input type="text" name="ingredients" value="<?php if ($update == true){echo $ingredients;} else echo ""?>">
        <label>Quantity</label>
        </br>
        <input type="text" name="quantity" value="<?php if ($update == true){echo $quantity;} else echo ""?>">
        <label>Price</label>
        </br>
      ...
      <br/>  
        ...
        ?>  
        <div class="col-md-4">  
             <form method="post" action="./menu_display_admin.php?action=add&id=<?php echo $row['Id']; ?>">  
                  <div style="border:1px solid #333; background-color:#f1f1f1; border-radius:5px; padding:16px;" align="center">
                       ...
                       <h4 class="text-info"><?php echo 'Quantity: ' . $row["Quantity"]; ?></h4>      
                       ...
                       <button type="submit" name="edit" style="margin-top:5px; background-color: #000000; border-color: #000000;" class="btn btn-success"><a href="./menu_display_admin.php?edit=<?php echo $row['Id']; ?>">Edit</a></button>
                       <button type="submit" name="delete" style="margin-top:5px; background-color: #000000; border-color: #000000;" class="btn btn-success"><a href="./menu_display_admin.php?delete=<?php echo $row['Id']; ?>">Delete</a></button>
                  </div>
                  <br/>  
             </form>  
        </div>  
